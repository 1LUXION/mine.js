...
function mineWindowUIResize(a:any,b:any,c:any,d:any){
    if(!a){
        a = Number(prompt('What do you want the width is? (9~110)'));
        b = Number(prompt('What do you want the height is? (9~50)'));
        d = Number(prompt('What do you want the number of mines per box is? (1~4)'));
        c = Number(prompt('What do you want the sum of number of mines?'));
